...
import { ADMIN_SEED_EN, AUTO_SEED_EN, BIENVENIDA_SEED_EN, CALIFICAR_PLATAFORMA_SEED_EN, CUPOS_SEED_EN, EMPRESA_TRABAJOS_SEED_EN, FEEDBACK_TARDE_SEED_EN, GESTION_SEED_EN, GRUPO_DETALLE_SEED_EN, INCIDENCIAS_SEED_EN, NOTIF_MODALES_SEED_EN, ONBOARDING_INICIAL_SEED_EN, PROGRESO_SEED_EN, RECLUTAMIENTO_SEED_EN, RESUMEN_HOME_SEED_EN, TOP_ESTUDIANTES_SEED_EN, UBICACION_SEED_EN } from "../i18n/autoSeed";
